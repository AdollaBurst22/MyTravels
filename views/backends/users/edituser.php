...
<div class="col-md-9">
    ...
    <div class="col-md-8 offset-2 bg-dark mt-5 rounded">
        <h2 class="addUser-header p-4 text-white"> <i class="fa-solid fa-pen-to-square"></i> Edit User</h2>
        ...
        <form class="row g-3" action="../../controllers/userController.php" method="post">
            <div class="row px-4 pt-4 pb-2">               
                ...
                <div class="col-md-8">
                    <input type="text" name="username" class="form-control" id="username" value="<?php echo $usereditData['username'];  ?>">
                    <?php
            ...
            <div class="row px-4 pt-4 pb-2">               
                ...
                <div class="col-md-8">
                    <input type="email" name="email" class="form-control" id="username" value="<?php echo $usereditData['email'];  ?>">
                    <?php
            ...
            <div class="row px-4 pt-4 pb-2">               
                ...
                <div class="col-md-8">
                    <input type="password" name="password" class="form-control" id="username" value="<?php echo $usereditData['password'];  ?>">
                    <?php
            ...
            <div class="col-md-8 offset-4 pb-5">
                <button type="submit" class="btn btn-outline-success mx-2"> <i class="fa-regular fa-circle-check"></i> Update</button>
