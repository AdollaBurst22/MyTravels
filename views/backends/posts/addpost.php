...
<div class="col-md-9">
    ...
    <div class="col-md-8 offset-2 bg-dark rounded">
        <h2 class="text-white py-3 px-2"> <i class="fa-solid fa-plus"></i> Add New Post</h2>
        <form class="row g-3" action="../../controllers/postController.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row py-4 px-4">
                ...
                <div class="col-md-8">
                    <textarea name="description" id="description" class="form-control" cols="30" rows="5" placeholder="This is about...."></textarea>
                    <?php  
            ...
            <div class="col-md-8 offset-4 pb-5">
                <button type="submit" class="btn btn-outline-success mx-2"> <i class="fa-solid fa-upload"></i> Upload</button>
